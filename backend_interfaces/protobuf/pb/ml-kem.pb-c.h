...
typedef struct MlKemEncCheckDataMsg MlKemEncCheckDataMsg;
typedef struct MlKemDecCheckDataMsg MlKemDecCheckDataMsg;
...
struct  MlKemEncCheckDataMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData ek;
  uint64_t cipher;
  uint32_t check_success;
};
#define ML_KEM_ENC_CHECK_DATA_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ml_kem_enc_check_data_msg__descriptor) \
, {0,NULL}, 0, 0 }


struct  MlKemDecCheckDataMsg
{
  ProtobufCMessage base;
  ProtobufCBinaryData dk;
  uint64_t cipher;
...
#define ML_KEM_DEC_CHECK_DATA_MSG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ml_kem_dec_check_data_msg__descriptor) \
, {0,NULL}, 0, 0 }
...
typedef void (*MlKemDecapDataMsg_Closure)
                 (const MlKemDecapDataMsg *message,
                  void *closure_data);
typedef void (*MlKemEncCheckDataMsg_Closure)
                 (const MlKemEncCheckDataMsg *message,
                  void *closure_data);
typedef void (*MlKemDecCheckDataMsg_Closure)
                 (const MlKemDecCheckDataMsg *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor ml_kem_enc_check_data_msg__descriptor;
extern const ProtobufCMessageDescriptor ml_kem_dec_check_data_msg__descriptor;
